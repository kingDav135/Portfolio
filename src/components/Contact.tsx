...
export default function Contact() {
  const whatsappNumber = "2349165801724";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="flex gap-4 mt-10">
              <a href="https://github.com/kingDav135" target="_blank" rel="noopener noreferrer" className="w-12 h-12 glass rounded-full flex items-center justify-center hover:text-primary transition-colors">
